...
export default function About(props) {
	...
	//     }
	// }
	//dark mode button andr wala h isko hata k use krenge

	//mystyle variable yaha p set krega color sbka
	let myStyle = {
		color: props.mode === 'dark' ? 'white' : 'greay',
		...
		<div className="container" style={myStyle}>
			<div class="accordion" id="accordionExample" style={myStyle}>
				<div class="accordion-item" style={myStyle}>
					...
					>
						<div class="accordion-body" style={myStyle}>
							<strong style={myStyle}>This is the first item's accordion body.</strong> It is shown by default, until the collapse plugin adds the
				...
				<div class="accordion-item" style={myStyle}>
					...
					>
						<div class="accordion-body" style={myStyle}>
							<strong style={myStyle}>This is the third item's accordion body.</strong> It is hidden by default, until the collapse plugin adds the
							appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding
							via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just
							about any HTML can go within the <code>.accordion-body</code>, though the transition does limit overflow.
						</div>
...
//dark mode inbuilt button ko hata die h fr usestate variables tk ko hata  die h
//fr naya variable banae h myStyle jo ki nobject h agr props mode dark hoga to background ko grey set krega aur color ko white
